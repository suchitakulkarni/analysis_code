...
// Sun Apr  1 15:58:55 2018 by ROOT version 6.06/01
// from TTree Delphes/Analysis tree
// found on file: ./root_samples/Higgs_res_CMS_susy.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static const Int_t kMaxParticle = 4384;
   static const Int_t kMaxTrack = 203;
   static const Int_t kMaxTower = 323;
   static const Int_t kMaxEFlowTrack = 203;
   static const Int_t kMaxEFlowPhoton = 119;
   static const Int_t kMaxEFlowNeutralHadron = 152;
   static const Int_t kMaxGenJet = 14;
   static const Int_t kMaxGenMissingET = 1;
   static const Int_t kMaxJet = 12;
   static const Int_t kMaxElectron = 2;
   static const Int_t kMaxPhoton = 2;
   static const Int_t kMaxMuon = 2;
   static const Int_t kMaxFatJet = 4;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("./root_samples/Higgs_res_CMS_susy.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("./root_samples/Higgs_res_CMS_susy.root");
      }
